...
**NOTE:** Since the ipynb file is large, it may not render properly on GitHub. So, kindly download the file to view in jupyter or use [nbviewer.org](https://nbviewer.org/) to view this notebook
## Running the code
